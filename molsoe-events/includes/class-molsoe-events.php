...
class Molsoe_Events {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Molsoe_Events_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Molsoe_Events_Loader. Orchestrates the hooks of the plugin.
	 * - Molsoe_Events_i18n. Defines internationalization functionality.
	 * - Molsoe_Events_Admin. Defines all hooks for the admin area.
	 * - Molsoe_Events_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		...
		$this->loader = new Molsoe_Events_Loader();
	 ...
	 *
	 * Uses the Molsoe_Events_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	 ...
	 *
	 * @since     1.0.0
	 * @return    Molsoe_Events_Loader    Orchestrates the hooks of the plugin.
	 */

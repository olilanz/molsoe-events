...
class Molsoe_Events_Public {
	...
	public function resolve_shortcode($atts = [], $content = null) {
		...
		$content =  '<a href="" class="avia-button  avia-icon_select-no avia-color-teal avia-size-large avia-position-center " target="_blank"><span class="avia_iconbox_title">TILMELD MED STORT SMIL :-)</span></a>';
